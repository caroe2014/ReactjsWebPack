...
describe('BUY-39676 Verify tip is not added after clearing cart and coming back to tip page', function() {
    ...
    it('Clear cart , add item and verify if tip is already added', async  function () {
        ...
        itemsPage.clickPayNow();
        expect(gratuityPage.isGratuityPageVisible()).toBe(true);
        expect(gratuityPage.getTipAmount()).toBe('$0.00');
    });
